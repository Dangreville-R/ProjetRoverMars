...
/**
 * Classe ViabiliteWidget — Affiche le bilan de viabilité global.
 * Composant pur sans state, affiche le score, le statut et les moyennes.
 */
class ViabiliteWidget extends React.Component {
    /**
     * Retourne la couleur associée au score de viabilité.
     * @param {number} score
    ...
    render() {
        const { viabilite, showExplanation = false } = this.props;
                        ...
                        <div className="viabilite-widget__progress-bg">
                            <div 
                                ...
                                style={{ 
                                    ...
                                    backgroundColor: ViabiliteWidget.getScoreColor(viabilite.score) 
                                }}
                            />
                        </div>
                    </div>
